...
RcppExport SEXP _bloomjoin_rcpp_bloom_sizing(SEXP nSEXP, SEXP false_positive_rateSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type n(nSEXP);
    Rcpp::traits::input_parameter< double >::type false_positive_rate(false_positive_rateSEXP);
    rcpp_result_gen = Rcpp::wrap(rcpp_bloom_sizing(n, false_positive_rate));
    return rcpp_result_gen;
END_RCPP
}
// hash_keys32_cols
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_bloomjoin_rcpp_bloom_sizing", (DL_FUNC) &_bloomjoin_rcpp_bloom_sizing, 2},
